...
typedef struct Redirection {
	...
	struct CallIdentity	*newCallId	/* OPTIONAL */;
	struct PartyIdentity	*redirectedFrom	/* OPTIONAL */;
	struct PartyIdentity	*redirectedTo	/* OPTIONAL */;
	...
	VisibleString_t	*visitedSystemIdentity	/* OPTIONAL */;
	struct ProtocolSpecificParameters	*protocolSpecificParameters	/* OPTIONAL */;
	struct Redirection__signalingMsg {
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_Redirection;

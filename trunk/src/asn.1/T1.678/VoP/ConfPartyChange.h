...
#ifndef	_ConfPartyChange_H_
#define	_ConfPartyChange_H_
...
/* ConfPartyChange */
typedef struct ConfPartyChange {
	CaseIdentity_t	 caseId;
	IAPSystemIdentity_t	*iAPSystemId	/* OPTIONAL */;
	TimeStamp_t	 timestamp;
	struct ConfPartyChange__callId {
		A_SEQUENCE_OF(struct CallIdentity) list;
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} callId;
	struct ConfPartyChange__communicatingParties {
		A_SEQUENCE_OF(struct PartyIdentity) list;
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *communicatingParties;
	struct ConfPartyChange__removedParties {
		A_SEQUENCE_OF(struct PartyIdentity) list;
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *removedParties;
	struct ConfPartyChange__joinedParties {
		A_SEQUENCE_OF(struct PartyIdentity) list;
	...
	struct ConfPartyChange__signalingMsg {
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_ConfPartyChange;

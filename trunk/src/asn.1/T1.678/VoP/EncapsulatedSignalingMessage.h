...
#ifndef	_EncapsulatedSignalingMessage_H_
#define	_EncapsulatedSignalingMessage_H_
...
typedef struct EncapsulatedSignalingMessage {
	UTF8String_t	 signalingProt;
	OCTET_STRING_t	 sigMsg;
	
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} EncapsulatedSignalingMessage_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_EncapsulatedSignalingMessage;

#ifdef __cplusplus
}
#endif

#endif	/* _EncapsulatedSignalingMessage_H_ */

...
static asn_TYPE_member_t asn_MBR_Location_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Location, locationType),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Location, location),
...
static asn_TYPE_tag2member_t asn_MAP_Location_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* locationType at 471 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* location at 472 */
};

...
static asn_TYPE_tag2member_t asn_MAP_sepCCCpair_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* sepXmitCCC at 295 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* sepRecvCCC at 297 */
};
...
static asn_TYPE_member_t asn_MBR_CCCIdentity_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CCCIdentity, choice.combCCC),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_VisibleString,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CCCIdentity, choice.sepCCCpair),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CCCIdentity, choice.indXmitCCC),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CCCIdentity, choice.indRecvCCC),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CCCIdentity, choice.indCCC),
...
static asn_TYPE_tag2member_t asn_MAP_CCCIdentity_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* combCCC at 293 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* sepCCCpair at 295 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* indXmitCCC at 300 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* indRecvCCC at 302 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* indCCC at 304 */
};

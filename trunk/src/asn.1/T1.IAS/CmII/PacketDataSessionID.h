...
#ifndef	_PacketDataSessionID_H_
#define	_PacketDataSessionID_H_
...
/* PacketDataSessionID */
typedef Value_t	 PacketDataSessionID_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_PacketDataSessionID;
asn_struct_free_f PacketDataSessionID_free;
asn_struct_print_f PacketDataSessionID_print;
asn_constr_check_f PacketDataSessionID_constraint;
ber_type_decoder_f PacketDataSessionID_decode_ber;
der_type_encoder_f PacketDataSessionID_encode_der;
xer_type_decoder_f PacketDataSessionID_decode_xer;
xer_type_encoder_f PacketDataSessionID_encode_xer;

#ifdef __cplusplus
}
#endif

#endif	/* _PacketDataSessionID_H_ */

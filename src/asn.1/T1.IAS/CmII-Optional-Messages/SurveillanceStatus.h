...
#ifndef	_SurveillanceStatus_H_
#define	_SurveillanceStatus_H_
...
/* SurveillanceStatus */
typedef UTF8String_t	 SurveillanceStatus_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_SurveillanceStatus;
asn_struct_free_f SurveillanceStatus_free;
asn_struct_print_f SurveillanceStatus_print;
asn_constr_check_f SurveillanceStatus_constraint;
ber_type_decoder_f SurveillanceStatus_decode_ber;
der_type_encoder_f SurveillanceStatus_encode_der;
xer_type_decoder_f SurveillanceStatus_decode_xer;
xer_type_encoder_f SurveillanceStatus_encode_xer;

#ifdef __cplusplus
}
#endif

#endif	/* _SurveillanceStatus_H_ */

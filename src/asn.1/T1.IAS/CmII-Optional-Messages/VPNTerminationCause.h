...
#ifndef	_VPNTerminationCause_H_
#define	_VPNTerminationCause_H_
...
/* VPNTerminationCause */
typedef UTF8String_t	 VPNTerminationCause_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_VPNTerminationCause;
asn_struct_free_f VPNTerminationCause_free;
asn_struct_print_f VPNTerminationCause_print;
asn_constr_check_f VPNTerminationCause_constraint;
ber_type_decoder_f VPNTerminationCause_decode_ber;
der_type_encoder_f VPNTerminationCause_encode_der;
xer_type_decoder_f VPNTerminationCause_decode_xer;
xer_type_encoder_f VPNTerminationCause_encode_xer;

#ifdef __cplusplus
}
#endif

#endif	/* _VPNTerminationCause_H_ */

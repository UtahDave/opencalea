...
int
SurveillanceStatus_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
SurveillanceStatus_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
SurveillanceStatus_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	SurveillanceStatus_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
SurveillanceStatus_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
SurveillanceStatus_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
SurveillanceStatus_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
SurveillanceStatus_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
SurveillanceStatus_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
asn_TYPE_descriptor_t asn_DEF_SurveillanceStatus = {
	"SurveillanceStatus",
	"SurveillanceStatus",
	SurveillanceStatus_free,
	SurveillanceStatus_print,
	SurveillanceStatus_constraint,
	SurveillanceStatus_decode_ber,
	SurveillanceStatus_encode_der,
	SurveillanceStatus_decode_xer,
	SurveillanceStatus_encode_xer,
